...
import BackgroundPNG from "./assets/wave.jpg"; // Background image
import BookImage from "./assets/Booklesson.png"; // Replace with a relevant image for Biologi
...
const Biologi = () => {
  ...
  const submateriData = {
    "Biologi 1": ["Sel dan Jaringan", "Ekosistem", "Genetika", "Evolusi"],
    "Biologi 2": [
      "Fisiologi Manusia",
      "Bioteknologi",
      "Biologi Molekuler",
    ...
    "Biologi 3": ["Ekologi", "Imunologi", "Mikrobiologi", "Toksikologi"],
    "Biologi 4": [
      "Bioinformatika",
      "Biodiversitas",
      "Reproduksi",
          ...
          {Object.entries(filteredData).map(([submateri, subtopiks]) => (
            ...
            >
              ...
              <div className="mt-4 text-center">
                <Link
                  to={`/${submateri.replace(" ", "")}`} // Use the formatted submateri name (Biologi1, Biologi2)
